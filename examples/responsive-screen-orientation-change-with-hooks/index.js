...
const listenOrientationChange = ({
  ...
  Dimensions.addEventListener('change', (newDimensions) => {
    console.log(`EVENT LISTENER: newDimensions are: ${JSON.stringify(newDimensions)}`);

    // Retrieve and save new dimensions
    screenWidth = newDimensions.window.width;
    screenHeight = newDimensions.window.height;

    console.log(`EVENT LISTENER: Dimensions(screen): ${JSON.stringify(Dimensions.get('screen'))}`)
    console.log(`EVENT LISTENER: Dimensions(window): ${JSON.stringify(Dimensions.get('window'))}`)

    console.log(`EVENT LISTENER: w: ${screenWidth} x h: ${screenHeight}`);
    ...
    console.log(
      `EVENT LISTENER: setting orientation to: ${orientation.orientation}`
    );
